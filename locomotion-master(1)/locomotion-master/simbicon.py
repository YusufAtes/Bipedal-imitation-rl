...
parser.add_argument("-f", "--file_path", type=str, default="/home/baran/Bipedal-imitation-rl/locomotion-master(1)/locomotion-master/settings/cma_config_1.05.yml", help="path to config file (yml format)")
...
parser.add_argument("-mi", "--max_iters", type=int, default=4e4, help="iterations of episode")
