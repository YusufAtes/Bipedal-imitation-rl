...
def make_env(render=False, demo_mode=False, max_episode_steps=1_000):
    def _init():
...
if __name__ == "__main__":
    # 0) RUN IDENTIFIER ---------------------------------------------------------
    TOTAL_TIMESTEPS = 10_000_000  # ≈200 M env steps → ~48 h at 1 kHz sim rate
    ...
    model = PPO(
        ...
        n_steps=8192 // N_ENVS,  # steps per environment
