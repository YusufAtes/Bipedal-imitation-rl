...
class FFTMLPGenerator(BaseGaitGenerator):
    ...
    def __init__(
        self,
        weights_path: str | Path = _REPO / "kfold_results" / "FINAL_BEST_MODEL.pth",
        mean_path: str | Path = _REPO / "gait reference phase 2" / "mean.npy",
        std_path:  str | Path = _REPO / "gait reference phase 2" / "std.npy",
